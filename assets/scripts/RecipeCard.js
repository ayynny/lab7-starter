...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		shadowElement.appendChild(recipeStyle);
		shadowElement.appendChild(recipeArticle);
	...
	set data(data) {
		...
		const recipeArticle = this.shadowRoot.querySelector('article');    //Try .querySelector('recipeArticle') if this doesn't work
